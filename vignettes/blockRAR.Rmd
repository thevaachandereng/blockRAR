...
**a0**: The object **a0** set the parameter value of a in the prior in Beta(a, b).  

**b0**: The object **b0** set the parameter value of b in the prior in Beta(a, b).   
...
**number_mcmc**: The object **number_mcmc** determines the number of posterior sample draw randomly using Monte-Carlo method. 
